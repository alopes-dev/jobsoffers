        ...
        <ScrollView>
          <View style={styles.cardContainer}>
            <View style={{ flex: 1, flexDirection: 'row' }}>
              <View style={{ flex: 0.2 }}>
                <Icons name="ios-contacts" size={30} color={Colores.Primary} />
              </View>
              <View style={{ flex: 1.2 }}>
                ...
                <View style={{ height: 30 }}>
                  <View style={{ flex: 1, flexDirection: 'row' }}>
                    <Text style={styles.TextCaptionSmall}>Tipo contrato:</Text>
            ...
            <View style={{ flex: 1, flexDirection: 'row' }}>
              ...
              <View style={{ flex: 1.2 }}>
                <Subheading style={{ color: '#6ce3a3' }}>Beneficios</Subheading>
                <View style={{ height: 30 }}>
                  <View style={{ flex: 1, flexDirection: 'row' }}>
            ...
            <View style={{ flex: 1, flexDirection: 'row' }}>
              ...
              <View style={{ flex: 1.2 }}>
                <Subheading style={{ color: '#ff7d8b' }}>Descrição</Subheading>
                <View style={{ height: 30 }}>
                  <View style={{ flex: 1, flexDirection: 'row' }}>
                ...
                <View>
                  ...
                  <Paragraph>
                    ...
                    countries 10 years of experience in water utilities with at
                    least 50,000
                  </Paragraph>
                  <Paragraph>
            ...
            <View style={{ flex: 1, flexDirection: 'row' }}>
              ...
              <View style={{ flex: 1.2 }}>
                <Subheading style={{ color: '#73deed' }}>Requisitos</Subheading>
                <View>
                  <View style={{ flex: 1, flexDirection: 'row' }}>
                    <Text style={styles.TextCaptionSmall}>
                      Titulação mínima:
                ...
                <View>
                  <View style={{ flex: 1, flexDirection: 'row' }}>
                    ...
                    <Caption style={styles.TextCaption}>{Experiencia}</Caption>
                  </View>
                </View>
                <View>
                  <View style={{ flex: 1, flexDirection: 'row' }}>
                    <Text style={styles.TextCaptionSmall}>Carga Horária :</Text>
                    <Caption style={styles.TextCaption}>{CargaHoraria}</Caption>
                  </View>
                </View>
                <View>
                  <View style={{ flex: 1, flexDirection: 'row' }}>
                ...
                <View>
                  <View style={{ flex: 1, flexDirection: 'row' }}>
                    <Text style={styles.TextCaptionSmall}>Competências :</Text>
                    <Caption style={styles.TextCaption}>
