...
import { OportunidadeRenderData as renderData,getFuncoesByAreaId } from '../../../store/funcs/fetch'
...
const  AddOportunidade =  (props)=>{
    ...
    const handleSubmit = async (data, {reset})=>{
        ...
        delete data.area
        let result = await iservice.store({table:"oportunidade", value:data, properties:'TipoFormacaoId'})
