...
exports.insert = (req, res, next) => {
    // assign values
    const detalheId = uuid()
    const sysdate = new Date(Date.now())

    Detalhe.create({
        Id: detalheId,
        Designacao: req.body.designacao,
        NomeDaInstituicao: req.body.nomeDaInstituicao,
        DescricaoDaInstituicao: req.body.descricaoDaInstituicao,
        LocalDaInstituicao: req.body.localDaInstituicao,
...
exports.update = (req, res, next) => {
    ...
    Detalhe.update(req.body, { where: { Id: req.params.id } }).then(() => {
...
exports.delete = (req, res, next) => {
    ...
    Detalhe.destroy(req.params.id).then(() => {
