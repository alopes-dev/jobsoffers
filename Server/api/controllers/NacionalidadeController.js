...
exports.update = (req, res, next) => {
    ...
    Nacionalidade.update(req.body, { where: { Id: req.params.id } }).then(() => {
...
exports.delete = (req, res, next) => {
    ...
    Nacionalidade.destroy(req.params.id).then(() => {
